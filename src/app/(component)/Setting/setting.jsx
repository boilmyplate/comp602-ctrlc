...
import { doPasswordChange, updateUsername } from "@/app/(component)/Firebase/auth";
        ...
        <div className={styles.all}>
          ...
          <div className={styles.container}>
            ...
            <div className={styles["label-input-container"]}>
              ...
              />
              <button className={styles.save} onClick={userSubmit}>
                save{" "}
              </button>
            </div>
            ...
            <div className={styles["label-input-container"]}>
              ...
              />
              <button className={styles.save} onClick={passSubmit}>
                save{" "}
              </button>
            </div>
