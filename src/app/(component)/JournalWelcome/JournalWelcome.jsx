  ...
  return (
    <div className={styles["journal-grid"]}>
      ...
      <div className={styles["journalWelcome-container"]}>
        <h2 className={styles["journal-header"]}>My Daily Journal</h2> {/* Header for the journal */}
        ...
        <div className={styles["content-grid"]}>
          ...
          <div className={styles["text-container"]}>
            ...
            <div className={styles["button-container"]}>
              ...
              <div className={styles["past-entry-container"]}>
                <Link href="/past-entries" className={styles.link}>
              ...
              <div className={styles["new-entry-container"]}>
                <Link href="/newEntry" className={styles["plus-link"]}>
          ...
          <div className={styles["image-container"]}>
            <Image src="/journal.jpg" alt="Journal Image" width={400} height={300} />
          </div>
        </div>
      </div>
    </div>
